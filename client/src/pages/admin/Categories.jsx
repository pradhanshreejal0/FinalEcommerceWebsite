...
export default function Categories() {
  ...
  const closeDialog = () => {
    if (saving || uploadingIcon || uploadingImage) {
      return;
    }
   ...
   *
   * If category becomes a subcategory:
   * remove its SVG icon from the form.
   * ---------------------------------------------------------
   */
  ...
  const handleSvgUpload = async (event) => {
    ...
    /*
     * SVG is allowed ONLY for parent categories.
     */
    ...
    try {
      ...
      setSuccess("SVG icon uploaded successfully.");
    } catch (err) {
   ...
   * POST /api/upload
   *
   * If your existing image upload endpoint is different,
  ...
  const handleImageUpload = async (event) => {
    ...
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_API_URL || "https://finalecommercewebsite-backend.onrender.com/api"}/upload`,
        {
          method: "POST",
  ...
  const handleSubmit = async (event) => {
    ...
    /*
     * A subcategory cannot have an SVG.
     */
    ...
    /*
     * SVG data is sent ONLY for parent categories.
     */
