...
export const createOrder = async (req, res) => {
  try {
    ...
    // NOTE: We intentionally do NOT check or decrement product.stock here.
    // Customers can order any quantity regardless of listed stock — the
    // vendor manages their own stock number manually for their own
    // inventory tracking / low-stock alerts, and decides how to fulfill
